(function () {
  ...
  (self["webpackChunkbookApp_2"] = self["webpackChunkbookApp_2"] || []).push([["src_app_pages_about_about_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _AboutPageRoutingModule = function AboutPageRoutingModule() {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _AboutPageModule = function AboutPageModule() {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _capacitor_browser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! @capacitor/browser */
      28427);
      ...
      var _AboutPage = /*#__PURE__*/function () {
        ...
        _createClass(AboutPage, [{
          ...
          key: "openMalekzadSite",
          value: function openMalekzadSite() {
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.next = 2;
                      return _capacitor_browser__WEBPACK_IMPORTED_MODULE_2__.Browser.open({
                        url: 'http://www.mohammad-malekzad.ir'
                      });
          ...
          key: "openMalekzadInsta",
          value: function openMalekzadInsta() {
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      _context2.next = 2;
                      return _capacitor_browser__WEBPACK_IMPORTED_MODULE_2__.Browser.open({
                        url: 'https://www.instagram.com/farzammalekzad/'
                      });
          ...
          key: "downloadBookApp",
          value: function downloadBookApp() {
          ...
          key: "downloadBookAppLite",
          value: function downloadBookAppLite() {
          ...
          key: "downloadNcReport",
          value: function downloadNcReport() {
                ...
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      _context5.next = 2;
                      return _capacitor_browser__WEBPACK_IMPORTED_MODULE_2__.Browser.open({
                        url: 'https://cafebazaar.ir/app/ir.mohammad.malekzad'
                      });
                ...
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    case 0:
                      _context6.next = 2;
                      return _capacitor_browser__WEBPACK_IMPORTED_MODULE_2__.Browser.open({
                        url: 'https://www.instagram.com/downloadbook/'
                      });
      ...
      _AboutPage = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_4__.Component)({
        selector: 'app-about',
