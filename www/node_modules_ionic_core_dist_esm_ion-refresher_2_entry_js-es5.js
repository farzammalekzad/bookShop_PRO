(function () {
  ...
  (self["webpackChunkbookApp_2"] = self["webpackChunkbookApp_2"] || []).push([["node_modules_ionic_core_dist_esm_ion-refresher_2_entry_js"], {
    /***/
    39921:
    /*!********************************************************************!*\
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var createBaseAnimation = function createBaseAnimation(pullingRefresherIcon) {
        ...
        var baseAnimation = (0, _animation_096c6391_js__WEBPACK_IMPORTED_MODULE_5__.c)().duration(1000).easing('ease-out');
        var spinnerArrowContainerAnimation = (0, _animation_096c6391_js__WEBPACK_IMPORTED_MODULE_5__.c)().addElement(spinnerArrowContainer).keyframes([{
          offset: 0,
          opacity: '0.3'
        }, {
          offset: 0.45,
        ...
        var circleInnerAnimation = (0, _animation_096c6391_js__WEBPACK_IMPORTED_MODULE_5__.c)().addElement(circle).keyframes([{
          offset: 0,
        ...
        var circleOuterAnimation = (0, _animation_096c6391_js__WEBPACK_IMPORTED_MODULE_5__.c)().addElement(spinner).keyframes([{
          offset: 0,
        ...
        if (arrowContainer && arrow) {
          var arrowContainerAnimation = (0, _animation_096c6391_js__WEBPACK_IMPORTED_MODULE_5__.c)().addElement(arrowContainer).keyframes([{
            offset: 0,
          ...
          var arrowAnimation = (0, _animation_096c6391_js__WEBPACK_IMPORTED_MODULE_5__.c)().addElement(arrow).keyframes([{
            offset: 0,
      ...
      var createScaleAnimation = function createScaleAnimation(pullingRefresherIcon, refresherEl) {
        ...
        var spinnerAnimation = (0, _animation_096c6391_js__WEBPACK_IMPORTED_MODULE_5__.c)().addElement(pullingRefresherIcon).keyframes([{
          offset: 0,
      ...
      var createSnapBackAnimation = function createSnapBackAnimation(pullingRefresherIcon) {
        return (0, _animation_096c6391_js__WEBPACK_IMPORTED_MODULE_5__.c)().duration(125).addElement(pullingRefresherIcon).fromTo('transform', 'translateY(var(--ion-pulling-refresher-translate, 100px))', 'translateY(0px)');
              ...
              switch (_context.prev = _context.next) {
                ...
                case 3:
                  ...
                  return new Promise(function (resolve) {
                    return (0, _helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_3__.c)(refresherContent, resolve);
                  });
                ...
                case 5:
                  ...
                  return _context.abrupt("return", pullingSpinner !== null && refreshingSpinner !== null && (mode === 'ios' && (0, _ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.a)('mobile') && referenceEl.style.webkitOverflowScrolling !== undefined || mode === 'md'));
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      _context2.next = 2;
                      return shouldUseNativeRefresher(this.el, (0, _ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.b)(this));
                        ...
                        (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.f)(function () {
                          ...
                          if (scrollTop > 0) {
                            ...
                            /* Refreshing */
                              ...
                              var ratio = (0, _helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_3__.j)(0, scrollTop / (refresherHeight * 0.5), 1);
                              (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.c)(function () {
                          ...
                          var opacity = (0, _helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_3__.j)(0, Math.abs(scrollTop) / refresherHeight, 0.99);
                          var pullAmount = _this.progress = (0, _helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_3__.j)(0, (Math.abs(scrollTop) - 30) / MAX_PULL, 1);
                          var currentTickToShow = (0, _helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_3__.j)(0, Math.floor(pullAmount * NUM_TICKS), NUM_TICKS - 1);
                          ...
                          if (shouldShowRefreshingSpinner) {
                            ...
                            if (!_this.didRefresh) {
                              ...
                              (0, _haptic_27b3f981_js__WEBPACK_IMPORTED_MODULE_4__.d)({
                                style: 'light'
                              });
                              /**
              ...
              return regeneratorRuntime.wrap(function _callee6$(_context6) {
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    case 0:
                      circle = (0, _helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_3__.g)(pullingSpinner).querySelector('circle');
                      pullingRefresherIcon = this.el.querySelector('ion-refresher-content .refresher-pulling-icon');
                      refreshingCircle = (0, _helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_3__.g)(refreshingSpinner).querySelector('circle');
                    ...
                    case 6:
                      this.gesture = _context6.sent.createGesture({
                        ...
                        onMove: function onMove(ev) {
                          ...
                          _this2.progress = (0, _helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_3__.j)(0, ev.deltaY / 180 * 0.5, 1);
                        ...
                        onEnd: function onEnd(ev) {
                          ...
                          var progress = (0, _cubic_bezier_eea9a7a9_js__WEBPACK_IMPORTED_MODULE_2__.g)([0, 0], [0, 0], [1, 1], [1, 1], _this2.progress)[0];
                          var snapBackAnimation = createSnapBackAnimation(pullingRefresherIcon);

                          _this2.animations.push(snapBackAnimation);

                          (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.c)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
                ...
                while (1) {
                  switch (_context8.prev = _context8.next) {
                    ...
                    case 7:
                      _context8.next = 9;
                      return new Promise(function (resolve) {
                        return (0, _helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_3__.c)(contentEl, resolve);
                      });
                      ...
                      if (this.nativeRefresher) {
                        ...
                        if (!this.pointerDown) {
                          (0, _helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_3__.r)(function () {
                            return (0, _helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_3__.r)(function () {
        ...
        _createClass(RefresherContent, [{
          ...
          value: function componentWillLoad() {
            ...
            if (this.refreshingSpinner === undefined) {
              var _mode = (0, _ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.b)(this);
          ...
          value: function render() {
            ...
            return (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.H, {
            ...
            }, this.pullingIcon && hasSpinner && (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
              ...
              paused: true
            }), mode === 'md' && this.pullingIcon === 'circular' && (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
              ...
              lazy: false
            })), this.pullingText && (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
              "class": "refresher-pulling-text",
              innerHTML: (0, _index_9e3fe806_js__WEBPACK_IMPORTED_MODULE_6__.s)(this.pullingText)
            })), (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
              "class": "refresher-refreshing"
            }, this.refreshingSpinner && (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
              "class": "refresher-refreshing-icon"
            }, (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-spinner", {
              name: this.refreshingSpinner
            })), this.refreshingText && (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
              "class": "refresher-refreshing-text",
              innerHTML: (0, _index_9e3fe806_js__WEBPACK_IMPORTED_MODULE_6__.s)(this.refreshingText)
            })));
          }
        }, {
          key: "el",
