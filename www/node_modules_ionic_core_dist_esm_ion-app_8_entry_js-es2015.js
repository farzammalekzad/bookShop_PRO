(self["webpackChunkbookApp_2"] = self["webpackChunkbookApp_2"] || []).push([["node_modules_ionic_core_dist_esm_ion-app_8_entry_js"],{
...
/* harmony import */ var _index_931440b1_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./index-931440b1.js */ 54001);
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_swipe-back-fae97365_js").then(__webpack_require__.bind(__webpack_require__, /*! ./swipe-back-fae97365.js */ 53272))).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
        this.ani.onFinish(() => {
          this.gestureOrAnimationInProgress = false;
          if (this.swipeHandler) {
